...
We can generalize this concept to everything. Here are two examples:
...
-   Iterate over all list elements and apply the function to the element
    in each iteration
